...
# Script for installing Odoo V9 on Ubuntu 16.04, 15.04, 14.04 (could be used for other version too)
...
if [ $IS_ENTERPRISE = "True" ]; then
    ...
    GITHUB_RESPONSE=$(sudo git clone --depth 1 --branch 9.0 https://www.github.com/odoo/enterprise "$OE_HOME/enterprise/addons" 2>&1)
